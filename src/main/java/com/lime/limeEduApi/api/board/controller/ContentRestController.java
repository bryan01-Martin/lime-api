...
public class ContentRestController extends BaseController{
	...
	public ResponseDomain<ContentDto>selectContentList(@RequestBody BoardContentListReq boardContentListReq) {
	 ...
	 @ApiOperation(value = "게시글 작성", notes = "게시글 작성")
	    public ResponseDomain<Integer> createContent(@RequestBody ContentDto contentDto, MultipartFile file, @User@ApiIgnore UserDto userDto, BoardDto boardDto) throws Exception {
		 	contentDto.setRegSeq(userDto.getSeq());
		 	contentDto.setModSeq(userDto.getSeq());
			/* contentDto.setBoardSeq(boardDto.getSeq()); */
    ...
    public ResponseDomain<Integer> modContent(@RequestBody ContentDto contentDto, MultipartFile file, @User@ApiIgnore UserDto userDto) throws Exception{
		contentDto.setModSeq(userDto.getSeq());
